...
class _NewReservationFormState extends State<NewReservationForm> {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<TableReservationBloc, TableReservationState>(
                                ...
                                children: [
                                  for (var table in state.tables)
                                    InkWell(
                                      ...
                                      child: Container(
                                        color: state.selectedTable == table
                                            ? AppColor.color8
                                            : Colors.transparent,
